package dev.iwilltry42.timestrap.old
    ...
    private fun fetchTasks() {
        requestAPIArrayWithTokenAuth(
            ...
            if (success && response != null) {
                ...
                Toast.makeText(this, "Fetched ${TaskContent.TASKS.size} tasks", Toast.LENGTH_SHORT)
                    .show()
